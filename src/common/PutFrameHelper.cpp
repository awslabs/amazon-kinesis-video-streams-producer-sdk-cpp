...
PutFrameHelper::PutFrameHelper(shared_ptr<KinesisVideoStream> kinesis_video_stream, uint64_t mkv_timecode_scale_ns, uint32_t max_audio_queue_size,
                               uint32_t max_video_queue_size, uint32_t initial_buffer_size_audio, uint32_t initial_buffer_size_video)
    : kinesis_video_stream(kinesis_video_stream), data_buffer_size(max_video_queue_size), put_frame_status(true)
{
