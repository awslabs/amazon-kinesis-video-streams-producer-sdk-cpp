...
class Credentials {
  public:
     ...
     */
    Credentials(const std::string& access_key, const std::string& secret_key, const std::string& session_token = "",
...
class CredentialProvider {
  ...
  protected:
    ...
    const std::chrono::duration<uint64_t> CredentialProviderGracePeriod =
        std::chrono::seconds(5 + (MIN_STREAMING_TOKEN_EXPIRATION_DURATION + STREAMING_TOKEN_EXPIRATION_GRACE_PERIOD) / HUNDREDS_OF_NANOS_IN_A_SECOND);
