...
class KvsSinkDeviceInfoProvider : public DefaultDeviceInfoProvider {
  ...
  public:
    KvsSinkDeviceInfoProvider(uint64_t storage_size_mb, uint64_t stop_stream_timeout_sec, uint64_t service_call_connection_timeout_sec,
                              uint64_t service_call_completion_timeout_sec)
        : storage_size_mb_(storage_size_mb), stop_stream_timeout_sec_(stop_stream_timeout_sec),
