...
```
gst-launch-1.0 -v  souphttpsrc location="https://.../playlist.m3u8" ! hlsdemux ! tsdemux ! video/x-h264,format=avc,alignment=au ! h264parse ! kvssink stream-name="YourStreamName aws-region="YourRegion"
```

###### Running the `gst-launch-1.0` command to upload audio and video from HLS .m3u8 playlist.

```
gst-launch-1.0 -v  souphttpsrc location="https://.../playlist.m3u8" ! hlsdemux name=mux ! tsdemux ! video/x-h264,format=avc,alignment=au ! h264parse ! kvssink stream-name="YourStreamName" aws-region="YourRegion" streaming-type=offline name=sink mux. ! queue ! aacparse ! sink.
```
