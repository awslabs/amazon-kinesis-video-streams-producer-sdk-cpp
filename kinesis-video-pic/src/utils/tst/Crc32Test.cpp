...
TEST_F(Crc32Test, crc32FunctionalityTest)
{
    ...
    EXPECT_EQ((UINT32) 0xcbf53a1c, COMPUTE_CRC32((PBYTE) testStringNum, STRLEN(testStringNum)));
    EXPECT_EQ((UINT32) 0x18f4fd08, COMPUTE_CRC32((PBYTE) testString, STRLEN(testString)));
    EXPECT_EQ((UINT32) 0xe8b7be43, COMPUTE_CRC32((PBYTE) testStringSingleChar, STRLEN(testStringSingleChar)));
    EXPECT_EQ((UINT32) 0x46619d26, COMPUTE_CRC32((PBYTE) testStringLong, STRLEN(testStringLong)));
}