...
//
INLINE INT16 getInt16Swap(INT16 x)
{
    return SWAP_INT16(x);
}

INLINE INT16 getInt16NoSwap(INT16 x)
{
    return x;
}

INLINE INT32 getInt32Swap(INT32 x)
{
    return SWAP_INT32(x);
}

INLINE INT32 getInt32NoSwap(INT32 x)
{
    return x;
}

INLINE INT64 getInt64Swap(INT64 x)
{
    return SWAP_INT64(x);
}

INLINE INT64 getInt64NoSwap(INT64 x)
{
    return x;
}

INLINE VOID putInt16Swap(PINT16 px, INT16 x)
{
    *px = SWAP_INT16(x);
}

INLINE VOID putInt16NoSwap(PINT16 px, INT16 x)
{
    *px = x;
}

INLINE VOID putInt32Swap(PINT32 px, INT32 x)
{
    *px = SWAP_INT32(x);
}

INLINE VOID putInt32NoSwap(PINT32 px, INT32 x)
{
    *px = x;
}

INLINE VOID putInt64Swap(PINT64 px, INT64 x)
{
    *px = SWAP_INT64(x);
}

INLINE VOID putInt64NoSwap(PINT64 px, INT64 x)
{
    *px = x;
}
