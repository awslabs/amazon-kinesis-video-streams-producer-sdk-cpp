...
// External declaration for the default logger log level
extern volatile SIZE_T gLoggerLogLevel;

// Get the global log level
#define GET_LOGGER_LOG_LEVEL()                          (UINT32) ATOMIC_LOAD(&gLoggerLogLevel)

// Set the global log level
#define SET_LOGGER_LOG_LEVEL(l)                         ATOMIC_STORE(&gLoggerLogLevel, (SIZE_T) (l))
...
#define INVALID_TIMER_QUEUE_HANDLE_VALUE ((TIMER_QUEUE_HANDLE) INVALID_HANDLE_VALUE)
#endif
...
#define INVALID_SEMAPHORE_HANDLE_VALUE ((SEMAPHORE_HANDLE) INVALID_HANDLE_VALUE)
#endif
